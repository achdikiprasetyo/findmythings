    ...
    <div class="row mt-3">
        ...
        @method('PUT')
            ...
            <div class="form-group mb-3">
                ...
                <input type="text" class="form-control" name="nama_barang" id="namaBarang" value="{{ $barang->nama_barang }}" placeholder="Nama Barang">
            </div>
            <div class="form-group mb-3">
                <div class="row">
                    <div class="col-lg">
                        <label for="tangal" class="form-label">Tanggal</label>
                        <input type="date" class="form-control" name="tanggal" id="tangal" value="{{ $barang->tanggal }}" placeholder="Tanggal">
                    </div>
                    <div class="col-lg">
                        <label for="lokasi" class="form-label">Lokasi</label>
                        <input type="text" class="form-control" name="lokasi" id="lokasi" value="{{ $barang->lokasi }}" placeholder="Lokasi">
                    </div>
                </div>   
            </div>
            <div class="form-group mb-3">
                <div class="row">
                    <div class="col-lg">
                        ...
                        <input type="text" class="form-control" name="kontak" id="kontak" value="{{ $barang->kontak }}" placeholder="Kontak">
                    </div>
                    <div class="col-lg">
            ...
            <div class="mt-2">
                <img src="{{ asset('storage/gambar/'.$barang->gambar) }}" alt="Gambar Barang" style="max-height: 200px;">
            </div>
